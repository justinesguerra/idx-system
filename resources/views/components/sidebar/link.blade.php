...
@php
    $isActiveClasses =  $isActive ? 'text-white bg-[#EA5B0C] shadow-lg hover:bg-[#d2510a]' : 'text-gray-500 hover:text-gray-700 hover:bg-gray-100 dark:hover:text-gray-300 dark:hover:bg-dark-eval-2';
